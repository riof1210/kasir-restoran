        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama_barang" value="{{ $transaksi->nama_barang }}" class="form-control @error('nama_barang') is-invalid" @enderror>
                    @error('nama_barang')
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="kategori_id" value="{{ $barang->kategori_id }}" class="form-control @error('kategori_id') is-invalid" @enderror>
                    @error('kategori_id')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
